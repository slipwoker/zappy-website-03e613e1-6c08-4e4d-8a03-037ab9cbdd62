(function() {
    ...
    function handleContactForm() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            .catch(function() {
                showSuccessMessage(form, 'Something went wrong. Please try again.', true);
            })
            .finally(function() {
                if (submitButton) {
    ...
    function showSuccessMessage(form, message, isError) {
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '03e613e1-6c08-4e4d-8a03-037ab9cbdd62',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '03e613e1-6c08-4e4d-8a03-037ab9cbdd62';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '03e613e1-6c08-4e4d-8a03-037ab9cbdd62';
